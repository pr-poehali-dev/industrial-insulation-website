      ...
      <section className="relative min-h-screen flex items-center overflow-hidden" ref={heroVis.ref}>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20 text-white">
          <div className={`flex flex-col items-center text-center transition-all duration-1000 ${heroVis.visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            ...
            {/* Подзаголовок */}
            <p className="t-lead mb-10 max-w-xl text-white">Подбор и расчёты, поставка и монтаж теплоизоляционных конструкций на: трубопроводы, арматуру, оборудование, резервуары. Работаем по всей России.</p>
