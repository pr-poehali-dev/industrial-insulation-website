        ...
        <div className="grid lg:grid-cols-2 gap-20 lg:gap-28 items-stretch">
          ...
          <div className={`transition-all duration-700 ${aboutVis.visible ? "animate-fadeInLeft" : "opacity-0"}`}>
            ...
            <div className="space-y-6">
              <p className="t-lead leading-[1.9]" style={{ color: "#fff" }}>Профессиональный поставщик решений в области теплоизоляции, шумоизоляции и защитных покрытий для судостроения, промышленности и инженерных систем.</p>
              <p className="t-body leading-[1.85]" style={{ color: "rgba(255,255,255,0.85)" }}>
              ...
              <p className="t-body leading-[1.8]" style={{ color: "rgba(255,255,255,0.75)" }}>
