        ...
        <div className="grid lg:grid-cols-2 gap-20 lg:gap-28 items-stretch">
          ...
          <div className={`transition-all duration-700 ${aboutVis.visible ? "animate-fadeInLeft" : "opacity-0"}`}>
            ...
            <div className="space-y-6">
              <p className="t-lead text-gray-800 leading-[1.9]">Профессиональный поставщик решений в области теплоизоляции, шумоизоляции и защитных покрытий для судостроения, промышленности и инженерных систем.</p>
