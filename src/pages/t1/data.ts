...
export const SERVICES = [
  ...
  { icon: "Database", title: "Изоляция резервуаров",             kw: "",                           desc: "Утепление резервуаров РВС, РГС, ёмкостей для нефтепродуктов и химических веществ. Проектирование и монтаж под ключ.",                                                                               tag: "" },
  ...
  { icon: "Wrench",   title: "Монтаж теплоизоляции под ключ",   kw: "монтаж теплоизоляции",       desc: "Полный цикл: проектирование, поставка материалов, монтаж, сдача объекта с документацией. Один подрядчик — ноль лишних согласований.",                                                               tag: "Популярно" },
];
